...
- Changes: added bundle verifier tooling, wired verification into gpt-bundle, added bundle hygiene tests + doc updates, and set run logs/bundles to local-only.
