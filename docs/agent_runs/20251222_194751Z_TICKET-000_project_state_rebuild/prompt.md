...
The user provided the following prompt (verbatim), plus a clarification to follow their format for this run.
...
User clarification: "follow my format since this is different"
